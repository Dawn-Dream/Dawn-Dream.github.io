...
<main id="rin-main">
    <div class="mdui-card rin-card">
        ...
        <div class="rin-card-part" id="introduce">
            <div class="rin-card-content mdui-typo">你好，这里是晓梦，不是基佬！<br>
                坐标广东东莞，是初中生。对信息技术以及ACG文化感兴趣。<br>
                咱有很多昵称：DawnDream、xm2020、GAY(。<br>
        ...
        <div class="rin-card-part" id="fighting">
            ...
            <div class="mdui-container">
                <div class="mdui-row">
                    <div class="mdui-col-xs-12 mdui-col-sm-6 mdui-col-md-4" mdui-tooltip="{content: '制作网站的能力:无'}">
                        <div class="mdui-container">
                    ...
                    <div class="mdui-col-xs-12 mdui-col-sm-6 mdui-col-md-4" mdui-tooltip="{content: 'JAVA学的我头皮发麻'}">
                        <div class="mdui-container">
                            <div class="mdui-row mdui-valign">
                                <div class="mdui-col-xs-4">
                                    <div class="rin-card-content">
                    ...
                    <div class="mdui-col-xs-12 mdui-col-sm-6 mdui-col-md-4" mdui-tooltip="{content: '完全不会('}">
                        <div class="mdui-container">
                            <div class="mdui-row mdui-valign">
                                <div class="mdui-col-xs-4">
                                    <div class="rin-card-content">
                                ...
                                <div class="mdui-col-xs-8">
                                    <div class="mdui-progress">
                                        <div class="mdui-progress-determinate" style="width: 5%;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="mdui-row">
                    <div class="mdui-col-xs-12 mdui-col-sm-6 mdui-col-md-4" mdui-tooltip="{content: 'QAQ!'}">
                        <div class="mdui-container">
                    ...
                    <div class="mdui-col-xs-12 mdui-col-sm-6 mdui-col-md-4" mdui-tooltip="{content: '让事情发生的能力'}">
                        <div class="mdui-container">
                            <div class="mdui-row mdui-valign">
                                ...
                                <div class="mdui-col-xs-8">
                                    <div class="mdui-progress">
                                        <div class="mdui-progress-determinate" style="width: 90%;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mdui-col-xs-12 mdui-col-sm-6 mdui-col-md-4" mdui-tooltip="{content: '直男'}">
                        <div class="mdui-container">
                            <div class="mdui-row mdui-valign">
                                <div class="mdui-col-xs-4">
                                    <div class="rin-card-content">
                ...
                <div class="mdui-row">
                    ...
                    <div class="mdui-col-xs-12 mdui-col-sm-6 mdui-col-md-4" mdui-tooltip="{content: '我 恨 人 类'}">
                        <div class="mdui-container">
                            <div class="mdui-row mdui-valign">
                                <div class="mdui-col-xs-4">
                                    <div class="rin-card-content">
        ...
        <div class="rin-card-part" id="website">
            ...
            <a class="mdui-btn mdui-btn-raised rin-btn rin-btn-blue mdui-text-capitalize" href="http://blog.dawndream.top:4000"
               target="_blank"><span class="iconfont iconBlog"></span> 博客</a>

            <a class="mdui-btn mdui-btn-raised rin-btn rin-btn-black mdui-text-capitalize" href="https://dawndream.top/old.Dawn-Dream.github.io"
               target="_blank"><span class="iconfont iconlab"></span> 旧主页</a>
        </div>
        ...
        <div class="rin-card-part" id="contact">
            ...
            <a class="mdui-btn mdui-btn-raised rin-btn rin-btn-black mdui-text-capitalize"
               href="https://github.com/Dawn-Dream" target="_blank"><span class="iconfont icongithub"></span> Github</a>

            <a class="mdui-btn mdui-btn-raised rin-btn rin-btn-pink mdui-text-capitalize"
               href="https://space.bilibili.com/111151688" target="_blank"><span class="iconfont iconbilibili"></span>
                Bilibili</a>

            <a class="mdui-btn mdui-btn-raised rin-btn rin-btn-blue mdui-text-capitalize"
               href="mailto:1040545078@qq.com" target="_blank"><span class="iconfont iconmail_fill"></span> Mail</a>
        ...
        <div class="rin-card-part" id="other">
            ...
            <a class="mdui-btn mdui-btn-raised rin-btn rin-btn-blue mdui-text-capitalize"
               href="#" onclick="alert('都说了敬请期待啦!')">敬请期待</a>

        </div>
        
        <div class="rin-card-part" id="music">
            <div class="rin-card-title2 mdui-typo"><a href="#other">#</a> 你也很无聊？来听音乐吧!</div>
            <iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width=330 height=86 src="//music.163.com/outchain/player?type=2&id=416552392&auto=0&height=66"></iframe>
            <?php
                $url = 'http://api.heterocraft.top/api/neteasemusic.php';
                $data = '?a=416552392&b=416552392&c=416552392';
                $get = $url.$data;
        ...
        <div class="rin-card-part" id="last">
            <div class="rin-card-title2">DawnDream</div>
            <div class="rin-card-content">告别是最好的开始</div>
        </div>

        <div class="rin-card-part" id="footer">
            <div class="rin-card-content">©2020-2021 DawnDream | 晓梦 | From: <a
                    href="https://github.com/AyagawaSeirin/" id="bg-link" target="_blank">github</a></div>
        </div>
    </div>
</main>
